...
Just a software that is an ongoing project, but baically it's a software that manages the amount of money you have at one time and the value in physical bills present. So you don't have to be counting it everytime you want to know how much you have in cash. [name,username,password are as followed (phillip,sierra,716715) there is currently no option to changes these information in the relased .exe file, but you can change it in the debug file unbuild version so if you want to do that it's fine.]
